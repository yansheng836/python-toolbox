...
https://github.com/yansheng836/python-toolbox/releases

v2.0.3版本，github 没有添加zip包！！！

#### 文件去重功能

1. 存在大小，创建时间、修改时间 都一样的文件，文件名多一个(1)，要怎么去重？？？

2. 跳完成弹窗，电脑会有声音，是否可以控制？

3. 删除重复之后，不再自动“开始扫描”，建议加个打勾功能。
4. 浏览，选择目录之后，自动开始扫描。
5. 点击“开始扫描”之后，进度条顶部有个50%的细线，是否可以去掉？？？
